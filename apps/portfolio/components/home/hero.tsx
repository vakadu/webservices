                ...
                <div className="w-full">
                    <div className="relative pt-[120px]">
                        <div className="text-center md:text-left">
                            <div className="max-w-[740px] mb-[420px] lg:mb-0">
                                <div className="text-14 md:text-15 uppercase tracking-0.10 dark:text-white">
                                    <span>
                                ...
                                <div className="text-14 md:text-15 uppercase font-medium tracking-0.05 flex items-center mt-32 justify-center lg:justify-start">
                                    I am a <span className="font-jost text-24 md:text-32 ml-12 text-brand dark:text-white">Frontend Developer</span>
                                </div>
                            </div>
                        ...
                        <div className="absolute scale-50 lg:scale-90 bottom-0 top-[680px] lg:top-1/2 right-auto -ml-[340px] left-1/2 lg:left-auto lg:-right-[100px] w-[680px] h-[800px] -mt-[390px] z-[2] origin-top-center">
