				...
				<section className="relative pt-[120px] w-full">
					<article className="text-center md:text-left">
						<section className="max-w-[740px] mb-[420px] lg:mb-0">
							...
							>
								<TextLoop>
									<span className="font-jost text-24 md:text-32 ml-12 text-brand dark:text-white">
										Frontend Developer
									</span>
									<span className="font-jost text-24 md:text-32 ml-12 text-brand dark:text-white">
										App Developer
						...
						<section className="lg:max-w-xs py-40">
							...
							>
								<p className="text-14 md:text-18">
									Creating Awesome Apps and Websites. Your Vision, Brought to Life
									by Me.
								</p>
							</article>
						</section>
						<section data-aos="fade-up" data-aos-duration="1200" data-aos-delay="400">
							<Button
								...
								onClick={() =>
									window.open(
										'https://res.cloudinary.com/dovja5zeh/image/upload/v1725019829/Vinod_Kumar_-_Front_End_Engineer_k9n6ri.pdf'
									)
								}
							>
						...
						<div className="absolute z-5 top-[420px] -left-[120px]">
							<ul className="m-0 p-0 list-none">
								<li className="m-0 flex items-center text-black border-[2px] border-dark-bg dark:border-grey-dark-shade rounded-full h-[82px] w-[250px] px-20 justify-center mt-[160px] ml-[100px] shadow-1 bg-white dark:bg-dark-bg">
									<span className="block text-[38px] w-[50%] text-center leading-[20px] dark:text-white">
										6 <strong>+</strong>
									</span>
									<span className="w-[50%] uppercase text-13 leading-[20px] dark:text-white font-semibold">
										Years of <strong className="text-brand">Experience</strong>
									</span>
								</li>
							</ul>
						</div>
